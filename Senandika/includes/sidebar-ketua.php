    ...
    <nav class="sidebar-nav">
        <a href="<?= $asset_path ?>dashboard/ketua/index.php"
        class="nav-link-item <?= ($current_page === 'index.php' && $current_dir === 'ketua') ? 'active' : '' ?>">
        <i class="bi bi-house"></i>
        Dashboard
        </a>

        <a href="<?= $asset_path ?>dashboard/ketua/pages/laporan-arsip.php"
        class="nav-link-item <?= ($current_page === 'laporan-arsip.php') ? 'active' : '' ?>">
