<?php
/**
 * HALAMAN LAPORAN ARSIP - DASHBOARD KETUA
 * Digunakan oleh Ketua untuk melihat daftar seluruh arsip yang ada di sistem.
 * Dilengkapi dengan filter kategori untuk memudahkan pengawasan dokumen.
 */
    ...
    <div class="table-card">
        ...
        <div class="table-responsive">
          <table class="table-custom" id="laporanTable">
              ...
              <?php
              /**
               * LOGIKA PENARIKAN DATA LAPORAN
               * Mengambil data dari tabel dokumen dengan filter kategori jika dipilih.
               */
              ...
              // Cek apakah filter kategori aktif
              if (!empty($kategori)) {
              ...
              <tr>
                  ...
                  <td>
                  <!-- Link Lihat File yang diarahkan ke Cloud Storage -->
